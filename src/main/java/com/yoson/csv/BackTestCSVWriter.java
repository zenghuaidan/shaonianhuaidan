...
//		return "combinationKey,Date,version,Source,PnL,\n";
	...
	public static String getBTSummaryHeader() {
		return "Test no.,version,Source,T-Short,T-Long,T-Long2,HLD,Stoploss,Trade Stop Loss,Instant Trade Stop Loss,Its Counter,Stop Gain Percent,Stop Gain Trigger,Morning Start Time,Lunch Start Time,Cash per index point,Trading fee,Other cost per trade,No. of days,Total PnL,Average PnL ,Total trades,Average trades,No. of winning days,No. of losing days,Winning %,Average gain per +ve trade,Average gain per -ve trade,Average 0 PnL trades,Average no. of positive trade,Average no. of negative trade,Average holding time,Adjusted Profit after fee,Worst Lossing Day,Best Profit Day,Worst Lossing Streak,Best Winning Streak,Lossing Streak freq,Winning Streak freq,Sum Of Lossing Streak,Sum Of Winning Streak,Avg Of Lossing Streak,Avg Of Winning Streak,Max Lossing Streak Length,Max Winning Streak Length,Start Time,End Time,Total Pnl by Year\n";
	}
