...
public class TradePerSecondDetailsCSVWriter {
	...
	private static void writeHeader(FileWriter writer, MainUIParam mainUIParam, String symbol)
	{
	    try
	    {
			...
			writer.append("\n");
			writer.append("Supper Time Start");
			writer.append(",");
			writer.append(mainUIParam.getSupperStartTimeFrom());
			writer.append("\n");
			writer.append("Supper Time End");
			writer.append(",");
			writer.append(mainUIParam.getSupperStartTimeTo());
			writer.append("\n");
			...
			writer.append("\n");
			writer.append("Include Afternoon Data");
			writer.append(",");
			writer.append(mainUIParam.isIncludeAfternoonData() + "");
			writer.append("\n");
