...
public class TimeZoneAspect {
    ...
    public void doBefore(JoinPoint jp){
    	String timezone = EClientSocketUtils.connectionInfo == null ? ConnectionInfo.getDefaultConnectionInfo().getTimeZone() : EClientSocketUtils.connectionInfo.getTimeZone();
		TimeZone previousTimeZone = TimeZone.getDefault();
    	
		if(!timezone.equals(previousTimeZone.getID())) {
