...
public class Contract implements Cloneable {
	...
	public String ID() {
		return this.m_secType + this.m_symbol + this.m_currency + this.m_exchange + this.m_localSymbol + this.m_expiry + this.startTime + this.endTime;
	}
	...
	public void setLocalSymbol(String localSymbol) {
		this.m_localSymbol = localSymbol;
	}
