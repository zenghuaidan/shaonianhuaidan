...
function updateControlTab() {
	$.ajax({
	    ...
	    url: "getAllStrategy",
	    success: function(data) {
	    	var trs = "<tr><td>Pannel Number</td><td>Execute</td><td>dyH</td><td>buffer</td><td>tradestoploss</td><td>stoploss</td><td>stop gain %</td><td>stop gain trigger</td><td>Trade Count</td><td>pnl</td></tr>";
	    	for(var i = 0; i < data.length; i++) {	    			    		
	    		trs += "<tr><td>" + data[i].strategyName + "</td><td>" + data[i].active + "</td><td>" + data[i].mainUIParam.tShort + "</td><td>" + data[i].mainUIParam.hld + "</td><td>" + data[i].mainUIParam.tradeStopLoss + "</td><td>" + data[i].mainUIParam.stopLoss + "</td><td>" + data[i].mainUIParam.stopGainPercent + "</td><td>" + data[i].mainUIParam.stopGainTrigger + "</td><td>" + data[i].tradeCount + "</td><td>" + data[i].pnl + "</td></tr>";
	    	}
